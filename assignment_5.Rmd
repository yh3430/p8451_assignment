...
# All the evaluation parameters should that all the above three model performed roughly the same. Based on Accuracy, the logistic regression model
# slightly better with a narrower 95% CI. So the final choice of model is the traditional logistic regression with all the features.
```

## Question 3 evaluation the chosen final model within test dataset
```{r}
# Model 2, the final model - traditional logistic model use all features
test_outcome_2 <- predict(fit_model_2, test_data)
